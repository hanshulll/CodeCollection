...
namespace Sorting_Algorithms_In_C_Sharp
{
    public static class BucketSort
    {
        ...
        //Bucketsort isn't a good choice if distribution of the data
        //Bucket Sort time complexity is high
        ...
        public static List<int> BucketSort1(params int[] x)
        {
            ...
            //Each sublist is sorted using Bubblesort, but you could substitute any sorting along you would like
            for (int i = 0; i < numOfBuckets; i++)
            {
